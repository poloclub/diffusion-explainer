...
d3.select("#generate-text-vector-l3-expl-text-container")
    .append("div")
        ...
        .append("div")
            ...
            .text("Stable Diffusion uses a special")
...
d3.select("#generate-text-vector-l3-expl-text-1")
    .append("div")
        ...
        .text("that connects text with image.")
d3.select("#generate-text-vector-l3-expl-text-container")
    .append("div")
    .attr("id", "generate-text-vector-l3-expl-text-2")
    .text("For an image-caption pair, the Text Encoder converts the caption's tokens")
d3.select("#generate-text-vector-l3-expl-text-container")
    .append("div")
    .attr("id", "generate-text-vector-l3-expl-text-3")
    .text("into a vector that is close to the image's vector, produced by a paired")
d3.select("#generate-text-vector-l3-expl-text-container")
    .append("div")
    .attr("id", "generate-text-vector-l3-expl-text-4")
    .text("image encoder (not used in Stable Diffusion), in hybrid text-image space.")
